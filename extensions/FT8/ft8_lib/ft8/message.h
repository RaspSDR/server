...
#define FTX_MAX_MESSAGE_LENGTH   (FTX_NFIELDS*FTX_FIELD_SZ + (FTX_NFIELDS-1)*1 + SPACE_FOR_NULL) ///< max message length = callsign[13] + space + callsign[13] + space + report[6] + terminator

...
function DSC(init, output_cb) {
   ...
   if (t.test_msgs) {
      ...
      t.tlist.push([ IS, SAF, TST, { s:'Bto1', n:0 }, { s:'Bto2', n:36 }, { s:'Bto3', n:69 }, { s:'Bto4', n:99 }, { s:'Bto5', n:30 }, EOS ]);
      // 4.7 FM call req
      ...
      // 4.6 from => to:geo
      t.tlist.push([ GEO, URG, J3E_RT, MED, { s:'Bto1', n:21 }, { s:'Bto2', n:21 }, { s:'Bto3', n:34 }, { s:'Bto4', n:2 }, { s:'Bto5', n:3 }, F1, F2, F3, EOS ]);
      // 4.7 freq
      t.tlist.push([ IS, SAF, J3E_RT, F1, F2, F3, G1, G2, G3, ARQ ]);
      // 4.8 from => to:ship-group
      t.tlist.push([ GRP, ROU, FSK_FEC, { s:'Bto1', n:2 }, { s:'Bto2', n:19 }, { s:'Bto3', n:0 }, { s:'Bto4', n:0 }, { s:'Bto5', n:0 }, F1, F2, F3, EOS ]);
      // 4.9 unable

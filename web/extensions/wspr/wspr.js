	...
	w3_div('id-wspr-controls',
	   w3_div('id-wspr-controls-top',
         ...
         w3_inline('w3-halign-space-between/',
            w3_div('cl-wspr-pie|background-color:var(--ui-surface-2)',
         ...
         w3_div('|background-color:var(--ui-surface-2); color:var(--ui-text); overflow:auto; width:100%; margin-top:5px; margin-bottom:0px; font-family:monospace; font-size:100%',
            '<pre style="display:inline"> UTC  dB   dT      Freq dF  Call   Grid    km  dBm</pre>'
            //                                                   dd  cccccc GGGG ddddd  nnn (n W)
         )
      ),
      
		w3_div('id-wspr-decode|white-space:pre; color:var(--ui-text); background-color:var(--ui-surface); overflow:scroll; height:100px; width:100%; margin-top:0px; font-family:monospace; font-size:100%')
	);

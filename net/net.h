...
typedef enum { IS_NOT_LOCAL,
               IS_LOCAL,
               NO_LOCAL_IF } isLocal_t;
...
u4_t inet4_d2h(const char* inet4_str, bool* error, u1_t* ap = NULL, u1_t* bp = NULL, u1_t* cp = NULL, u1_t* dp = NULL);
